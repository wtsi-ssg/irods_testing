...
#This is replaced by a compound Resource
...
@include "acPreprocForDataObjOpen"
...
#No longer needed if we move to a composable resurce that does replication
acPostProcForPut { }

#@include "acPostProcForPut"
